...
export const networkConfigs = {
  ...
  pulsechain: {
    addresses: {
      ensRegistry: '0x070aDBF46abABFfdB4733B396E852cEfA2F281B9',
    },
    nodes: {
      defaultEth: 'wss://rpc.v4.testnet.pulsechain.com',
    },
    settings: {
      chainId: 943,
      name: 'Pulsechain testnet v4',
      shortName: 'Pulsechain Testnet V4',
      type: 'private', // as returned by web3.eth.net.getNetworkType()
      live: true,
    },
    // providers: ['injected', 'frame'],
    providers: [
      ...
      {
        id: 'walletconnect',
        conf: 'https://rpc.v4.testnet.pulsechain.com',
      },
    ],
  },
  private: {
    ...
    nodes: {
      defaultEth: 'wss://rpc.v4.testnet.pulsechain.com', // wss://rpc.v4.testnet.pulsechain.com
    },
    settings: {
      chainId: 943,
      name: 'Pulsechain testnet v4',
