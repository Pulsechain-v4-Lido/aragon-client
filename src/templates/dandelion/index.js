...
export default {
  id: 'dandelion-org-template.lidopm.eth',
  name: 'Dandelion',
  new: true,
  header,
  icon,
  ...
  apps: [
    ...
    {
      appName: 'dandelion-voting.lidopm.eth',
      label: 'Voting',
    },
    { appName: 'time-lock.lidopm.eth', label: 'Time Lock' },
    { appName: 'redemptions.lidopm.eth', label: 'Redemptions' },
    { appName: 'token-request.lidopm.eth', label: 'Token Request' },
  ],
          ...
          <ReviewScreen
            ...
            items={[
              ...
              },
              {
                label: (
                  <KnownAppBadge
                    appName="redemptions.lidopm.eth"
                    label="Redemptions"
                  />
                ),
              ...
              },
              {
                label: (
                  <KnownAppBadge
                    appName="token-request.lidopm.eth"
                    label="Token Request"
                  />
                ),
