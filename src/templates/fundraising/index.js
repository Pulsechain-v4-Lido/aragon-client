...
export default {
  id: 'fundraising-multisig-template.lidopm.eth',
  name: 'Fundraising',
  beta: true,
  header,
  icon,
  ...
  apps: [
    {
      appName: 'aragon-fundraising.lidopm.eth',
      label: 'Fundraising',
    },
    { appName: 'agent.lidopm.eth', label: 'Agent: Reserve Pool' },
    { appName: 'voting.lidopm.eth', label: 'Voting: Council' },
    { appName: 'token-manager.lidopm.eth', label: 'Tokens: Council' },
    { appName: 'voting.lidopm.eth', label: 'Voting: Token Holder' },
    { appName: 'token-manager.lidopm.eth', label: 'Tokens: Token Holder' },
